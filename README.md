...
This is company data ck

Please note that `rememberizer-mcp-company-data-ck` is currently in development and the functionality may be subject to change.
...
If you have SkyDeck AI Helper app installed, you can search for "Rememberizer" and install the rememberizer-mcp-company-data-ck.
...
"mcpServers": {
  "rememberizer": {
      "command": "uvx",
      "args": ["rememberizer-mcp-company-data-ck"]
    },
}
```
